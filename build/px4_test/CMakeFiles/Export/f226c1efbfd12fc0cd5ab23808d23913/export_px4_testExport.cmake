...
foreach(_cmake_expected_target IN ITEMS px4_test::frame_transforms px4_test::px4_test px4_test::gazebo_clock)
...
# Create imported target px4_test::frame_transforms
add_library(px4_test::frame_transforms SHARED IMPORTED)

set_target_properties(px4_test::frame_transforms PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;/usr/include/eigen3;/usr/include/eigen3"
...
# Create imported target px4_test::px4_test
add_executable(px4_test::px4_test IMPORTED)

set_target_properties(px4_test::px4_test PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/usr/include/eigen3"
)

# Create imported target px4_test::gazebo_clock
add_executable(px4_test::gazebo_clock IMPORTED)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/export_px4_testExport-*.cmake")
